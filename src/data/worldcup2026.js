...
// flagImg: /flags/{iso2}.png 경로, 미확정 팀은 flag 이모지만 사용
export const INITIAL_GROUPS = {
  A: {
    teams: [
      { id: 'MEX', name: '멕시코', flag: '🇲🇽', flagImg: '/flags/mx.png', confederation: 'CONCACAF', host: true, yc: 2, twoYR: 0, dr: 0 },
      { id: 'KOR', name: '대한민국', flag: '🇰🇷', flagImg: '/flags/kr.png', confederation: 'AFC', yc: 1, twoYR: 0, dr: 0 },
      { id: 'RSA', name: '남아프리카공화국', flag: '🇿🇦', flagImg: '/flags/za.png', confederation: 'CAF', yc: 3, twoYR: 0, dr: 0 },
      { id: 'UEFA_PO_D', name: 'UEFA PO-D', flag: '🏴', flagImg: null, confederation: 'UEFA', playoff: 'UEFA 플레이오프 D (덴마크/체코/아일랜드/북마케도니아)', yc: 2, twoYR: 1, dr: 0 },
    ],
  },
  B: {
    teams: [
      { id: 'CAN', name: '캐나다', flag: '🇨🇦', flagImg: '/flags/ca.png', confederation: 'CONCACAF', host: true, yc: 1, twoYR: 0, dr: 0 },
      { id: 'CHE', name: '스위스', flag: '🇨🇭', flagImg: '/flags/ch.png', confederation: 'UEFA', yc: 2, twoYR: 0, dr: 0 },
      { id: 'QAT', name: '카타르', flag: '🇶🇦', flagImg: '/flags/qa.png', confederation: 'AFC', yc: 4, twoYR: 0, dr: 0 },
      { id: 'UEFA_PO_A', name: 'UEFA PO-A', flag: '🏴', flagImg: null, confederation: 'UEFA', playoff: 'UEFA 플레이오프 A (이탈리아/웨일스/보스니아/북아일랜드)', yc: 2, twoYR: 0, dr: 1 },
    ],
  },
  C: {
    teams: [
      { id: 'BRA', name: '브라질', flag: '🇧🇷', flagImg: '/flags/br.png', confederation: 'CONMEBOL', yc: 1, twoYR: 0, dr: 0 },
      { id: 'MAR', name: '모로코', flag: '🇲🇦', flagImg: '/flags/ma.png', confederation: 'CAF', yc: 2, twoYR: 0, dr: 0 },
      { id: 'SCO', name: '스코틀랜드', flag: '🏴󠁧󠁢󠁳󠁣󠁴󠁿', flagImg: '/flags/gb-sct.png', confederation: 'UEFA', yc: 4, twoYR: 1, dr: 0 },
      { id: 'HTI', name: '아이티', flag: '🇭🇹', flagImg: '/flags/ht.png', confederation: 'CONCACAF', yc: 3, twoYR: 0, dr: 1 },
    ],
  },
  D: {
    teams: [
      { id: 'USA', name: '미국', flag: '🇺🇸', flagImg: '/flags/us.png', confederation: 'CONCACAF', host: true, yc: 1, twoYR: 0, dr: 0 },
      { id: 'AUS', name: '호주', flag: '🇦🇺', flagImg: '/flags/au.png', confederation: 'AFC', yc: 2, twoYR: 0, dr: 0 },
      { id: 'PAR', name: '파라과이', flag: '🇵🇾', flagImg: '/flags/py.png', confederation: 'CONMEBOL', yc: 3, twoYR: 1, dr: 0 },
      { id: 'UEFA_PO_C', name: 'UEFA PO-C', flag: '🏴', flagImg: null, confederation: 'UEFA', playoff: 'UEFA 플레이오프 C (튀르키예/루마니아/슬로바키아/코소보)', yc: 2, twoYR: 0, dr: 0 },
    ],
  },
  E: {
    teams: [
      { id: 'GER', name: '독일', flag: '🇩🇪', flagImg: '/flags/de.png', confederation: 'UEFA', yc: 2, twoYR: 0, dr: 0 },
      { id: 'ECU', name: '에콰도르', flag: '🇪🇨', flagImg: '/flags/ec.png', confederation: 'CONMEBOL', yc: 1, twoYR: 0, dr: 0 },
      { id: 'CIV', name: '코트디부아르', flag: '🇨🇮', flagImg: '/flags/ci.png', confederation: 'CAF', yc: 3, twoYR: 0, dr: 0 },
      { id: 'CUW', name: '퀴라소', flag: '🇨🇼', flagImg: '/flags/cw.png', confederation: 'CONCACAF', yc: 4, twoYR: 0, dr: 1 },
    ],
  },
  F: {
    teams: [
      { id: 'NED', name: '네덜란드', flag: '🇳🇱', flagImg: '/flags/nl.png', confederation: 'UEFA', yc: 2, twoYR: 0, dr: 0 },
      { id: 'JPN', name: '일본', flag: '🇯🇵', flagImg: '/flags/jp.png', confederation: 'AFC', yc: 1, twoYR: 0, dr: 0 },
      { id: 'TUN', name: '튀니지', flag: '🇹🇳', flagImg: '/flags/tn.png', confederation: 'CAF', yc: 3, twoYR: 1, dr: 0 },
      { id: 'UEFA_PO_B', name: 'UEFA PO-B', flag: '🏴', flagImg: null, confederation: 'UEFA', playoff: 'UEFA 플레이오프 B (우크라이나/스웨덴/폴란드/알바니아)', yc: 2, twoYR: 0, dr: 0 },
    ],
  },
  G: {
    teams: [
      { id: 'BEL', name: '벨기에', flag: '🇧🇪', flagImg: '/flags/be.png', confederation: 'UEFA', yc: 2, twoYR: 0, dr: 0 },
      { id: 'IRN', name: '이란', flag: '🇮🇷', flagImg: '/flags/ir.png', confederation: 'AFC', yc: 3, twoYR: 0, dr: 1 },
      { id: 'EGY', name: '이집트', flag: '🇪🇬', flagImg: '/flags/eg.png', confederation: 'CAF', yc: 2, twoYR: 1, dr: 0 },
      { id: 'NZL', name: '뉴질랜드', flag: '🇳🇿', flagImg: '/flags/nz.png', confederation: 'OFC', yc: 1, twoYR: 0, dr: 0 },
    ],
  },
  H: {
    teams: [
      { id: 'ESP', name: '스페인', flag: '🇪🇸', flagImg: '/flags/es.png', confederation: 'UEFA', yc: 1, twoYR: 0, dr: 0 },
      { id: 'URU', name: '우루과이', flag: '🇺🇾', flagImg: '/flags/uy.png', confederation: 'CONMEBOL', yc: 2, twoYR: 0, dr: 0 },
      { id: 'SAU', name: '사우디아라비아', flag: '🇸🇦', flagImg: '/flags/sa.png', confederation: 'AFC', yc: 3, twoYR: 0, dr: 0 },
      { id: 'CPV', name: '카보베르데', flag: '🇨🇻', flagImg: '/flags/cv.png', confederation: 'CAF', yc: 4, twoYR: 1, dr: 0 },
    ],
  },
  I: {
    teams: [
      { id: 'FRA', name: '프랑스', flag: '🇫🇷', flagImg: '/flags/fr.png', confederation: 'UEFA', yc: 2, twoYR: 0, dr: 0 },
      { id: 'SEN', name: '세네갈', flag: '🇸🇳', flagImg: '/flags/sn.png', confederation: 'CAF', yc: 2, twoYR: 0, dr: 0 },
      { id: 'NOR', name: '노르웨이', flag: '🇳🇴', flagImg: '/flags/no.png', confederation: 'UEFA', yc: 1, twoYR: 0, dr: 0 },
      { id: 'IC_PO_2', name: 'IC PO-2', flag: '🏆', flagImg: null, confederation: 'AFC', playoff: '대륙간 플레이오프 2 (미확정)', yc: 3, twoYR: 0, dr: 0 },
    ],
  },
  J: {
    teams: [
      { id: 'ARG', name: '아르헨티나', flag: '🇦🇷', flagImg: '/flags/ar.png', confederation: 'CONMEBOL', yc: 1, twoYR: 0, dr: 0 },
      { id: 'AUT', name: '오스트리아', flag: '🇦🇹', flagImg: '/flags/at.png', confederation: 'UEFA', yc: 2, twoYR: 0, dr: 0 },
      { id: 'ALG', name: '알제리', flag: '🇩🇿', flagImg: '/flags/dz.png', confederation: 'CAF', yc: 3, twoYR: 1, dr: 0 },
      { id: 'JOR', name: '요르단', flag: '🇯🇴', flagImg: '/flags/jo.png', confederation: 'AFC', yc: 4, twoYR: 0, dr: 1 },
    ],
  },
  K: {
    teams: [
      { id: 'POR', name: '포르투갈', flag: '🇵🇹', flagImg: '/flags/pt.png', confederation: 'UEFA', yc: 1, twoYR: 0, dr: 0 },
      { id: 'COL', name: '콜롬비아', flag: '🇨🇴', flagImg: '/flags/co.png', confederation: 'CONMEBOL', yc: 2, twoYR: 0, dr: 0 },
      { id: 'UZB', name: '우즈베키스탄', flag: '🇺🇿', flagImg: '/flags/uz.png', confederation: 'AFC', yc: 3, twoYR: 0, dr: 0 },
      { id: 'IC_PO_1', name: 'IC PO-1', flag: '🏆', flagImg: null, confederation: 'CONCACAF', playoff: '대륙간 플레이오프 1 (미확정)', yc: 2, twoYR: 0, dr: 1 },
    ],
  },
  L: {
    teams: [
      { id: 'ENG', name: '잉글랜드', flag: '🏴󠁧󠁢󠁥󠁮󠁧󠁿', flagImg: '/flags/gb-eng.png', confederation: 'UEFA', yc: 2, twoYR: 0, dr: 0 },
      { id: 'CRO', name: '크로아티아', flag: '🇭🇷', flagImg: '/flags/hr.png', confederation: 'UEFA', yc: 2, twoYR: 0, dr: 0 },
      { id: 'GHA', name: '가나', flag: '🇬🇭', flagImg: '/flags/gh.png', confederation: 'CAF', yc: 3, twoYR: 1, dr: 0 },
      { id: 'PAN', name: '파나마', flag: '🇵🇦', flagImg: '/flags/pa.png', confederation: 'CONCACAF', yc: 4, twoYR: 0, dr: 1 },
    ],
  },
};
