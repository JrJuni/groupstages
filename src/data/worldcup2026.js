...
export const INITIAL_GROUPS = {
  A: {
    teams: [
      ...
      { id: 'UEFA_PO_D', name: 'UEFA PO-D', flag: '🏴', flagImg: null, confederation: 'UEFA', playoff: 'UEFA 플레이오프 D (덴마크/체코/아일랜드/북마케도니아)' },
    ],
  },
  B: {
    teams: [
      ...
      { id: 'UEFA_PO_A', name: 'UEFA PO-A', flag: '🏴', flagImg: null, confederation: 'UEFA', playoff: 'UEFA 플레이오프 A (이탈리아/웨일스/보스니아/북아일랜드)' },
    ],
  },
  C: {
    teams: [
  ...
  D: {
    teams: [
      ...
      { id: 'UEFA_PO_C', name: 'UEFA PO-C', flag: '🏴', flagImg: null, confederation: 'UEFA', playoff: 'UEFA 플레이오프 C (튀르키예/루마니아/슬로바키아/코소보)' },
    ],
  },
  E: {
    teams: [
  ...
  F: {
    teams: [
      ...
      { id: 'UEFA_PO_B', name: 'UEFA PO-B', flag: '🏴', flagImg: null, confederation: 'UEFA', playoff: 'UEFA 플레이오프 B (우크라이나/스웨덴/폴란드/알바니아)' },
    ],
  },
  G: {
    teams: [
  ...
  I: {
    teams: [
      ...
      { id: 'IC_PO_2', name: 'IC PO-2', flag: '🏆', flagImg: null, confederation: 'AFC', playoff: '대륙간 플레이오프 2 (미확정)' },
    ],
  },
  J: {
    teams: [
  ...
  K: {
    teams: [
      ...
      { id: 'IC_PO_1', name: 'IC PO-1', flag: '🏆', flagImg: null, confederation: 'CONCACAF', playoff: '대륙간 플레이오프 1 (미확정)' },
    ],
  },
  L: {
    teams: [
